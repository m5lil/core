...
الأقسام
    ...
    <div class="ui modal post_form">
        <div class="content">
            {{ Form::open(array('route' => 'posts.store', 'class' => 'ui form', 'id' => 'formpage','files' => true)) }}
            ...
            <div class="field">
                ...
                {!! Form::select('category_id', \App\Category::translated()->get()->pluck('title','id'), null) !!}
            </div>
                ...
                <tr class="item-{{$value->id}}">
                    ...
                    <td>
                        <div class="ui tiny buttons">
                            <a href="{{url('/dashboard/blog/posts/' . $value->id)}}/edit"
                               class="ui left blue mini attached button icon"><i class="edit icon"></i></a>
                            <a href="{{url('/dashboard/blog/posts/' . $value->id)}}/delete"
